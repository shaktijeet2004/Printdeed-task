...
function ShapeRenderer({ element }) {
  ...
  switch (shapeType) {
    case "rectangle":
      return (
        <svg className="canvas-shape" viewBox="0 0 24 24">
          <rect x="1" y="3" width="22" height="18" rx="2" fill={fill} />
        </svg>
      );
    case "circle":
      return (
    ...
    case "triangle":
      return (
        <svg className="canvas-shape" viewBox="0 0 24 24">
          <polygon points="12,1 23,23 1,23" fill={fill} />
        </svg>
      );
    case "star":
      return (
    ...
    case "diamond":
      return (
        <svg className="canvas-shape" viewBox="0 0 24 24">
          <polygon points="12,1 23,12 12,23 1,12" fill={fill} />
        </svg>
      );
    case "hexagon":
      return (
    ...
    case "arrow":
      return (
        <svg className="canvas-shape" viewBox="0 0 24 24">
          <polygon points="2,8 16,8 16,3 23,12 16,21 16,16 2,16" fill={fill} />
        </svg>
      );
    case "heart":
      return (
